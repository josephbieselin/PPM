...
#include "../../test_gui/workerthread.h"
...
QT_MOC_LITERAL(1, 13, 14), // "serialCommDone"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 6) // "doWork"

    },
    "WorkerThread\0serialCommDone\0\0doWork"
};
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->serialCommDone((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (WorkerThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WorkerThread::serialCommDone)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void WorkerThread::serialCommDone(QString _t1)
{
